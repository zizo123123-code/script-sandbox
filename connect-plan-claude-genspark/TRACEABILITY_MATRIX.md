...
> - `[GAP-XX]` = تحليل النواقص `02.01_GAP_ANALYSIS.md`
> - `[SDN]` = بروتوكول SWARM-DNA `02.00_SWARM_DNA_PROTOCOL.md`
...
| D-17 | 🐜 لوحة الفيرومونات (Stigmergy في Git خام) | [GAP-01] + طلب زيزو "حاجة محدش عملها" | تصميم جديد [SDN] — مستلهم من أنماط Stigmergy لكن التطبيق في ريبو خام غير مسبوق | T-013 |
| D-18 | 🧬 بطاقة DNA + شجرة الجينوم | [R2] `# Based-on:` موسع | تحويله لبطاقة كاملة + شجرة Mermaid آلية [SDN] | T-016 |
| D-19 | 🏆 سجل الثقة المحسوب من Git Trailers | [GAP-04] [GAP-07] | تصميم جديد [SDN] — معادلة نقاط قابلة للتدقيق | T-015 |
| D-20 | Git Trailers إلزامية (Agent-Code/Task-ID/Based-On) | [GAP-04] | معيار نسب آلي بدل الرسائل النصية | T-003 |
| D-21 | طابور قرارات موحد + سياسة أسرار + تعافي + Outbox | [GAP-02/03/05/10] | إضافات المراجعة الثانية | T-003, T-014 |
