...
"""
================================================================================
NoteGPT Operation — Audio Text-to-Speech  [STUB — NOT IMPLEMENTED]
================================================================================
...
MANIFEST STATE : capabilities.text_to_speech = unknown
EVIDENCE       : No evidence in code, catalog, or 916 HAR entries. Not claimed even by the original (REJECTED) inventory files.

WHY THIS FILE IS EMPTY
----------------------
No endpoint, no voice metadata, no audio asset flow. Nothing to implement.
...
def synthesize_speech(config: NoteGPTConfig, request: Dict[str, Any]) -> Dict[str, Any]:
    """NOT IMPLEMENTED — returns the normalized unsupported_capability error."""
    return {"error": err.unsupported_capability("synthesize_speech").to_dict()}
