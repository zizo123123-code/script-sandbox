...
"""
================================================================================
NoteGPT Account — Update  [STUB — NOT APPLICABLE]
================================================================================
...
NoteGPT exposes no endpoint to update an account programmatically; none appears
...
def update_account(*args: Any, **kwargs: Any) -> Dict[str, Any]:
    """NOT APPLICABLE — see module docstring."""
    return {"error": err.unsupported_capability("update_account").to_dict()}
