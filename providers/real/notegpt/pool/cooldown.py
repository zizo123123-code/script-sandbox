...
"""
================================================================================
NoteGPT Pool — Cooldown  [STUB — NOT APPLICABLE]
================================================================================
...
def apply_cooldown(*args: Any, **kwargs: Any) -> Dict[str, Any]:
    """NOT APPLICABLE — no account pool for this provider."""
    return {"error": err.unsupported_capability("apply_cooldown").to_dict()}
