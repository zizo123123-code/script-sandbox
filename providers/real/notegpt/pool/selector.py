...
"""
================================================================================
NoteGPT Pool — Selector  [STUB — NOT APPLICABLE]
================================================================================
...
def select_account(*args: Any, **kwargs: Any) -> Dict[str, Any]:
    """NOT APPLICABLE — no account pool for this provider."""
    return {"error": err.unsupported_capability("select_account").to_dict()}
