# -*- coding: utf-8 -*-
# ═══ DNA ═══
# Gene-ID:    ngpt/01.06_agent-mode
# Based-On:   ngpt/01.05_LEGACY_agent-mode
# Generation: 5
# Author:     AG
# Mutation:   "Smart Rebase & Live Browser Sync"
# Status:     verified
# ═══════════
"""
================================================================================
...
📌 الوصف:
    ...
    مع تفعيل بروتوكول الـ Smart Git Rebase والربط المباشر مع قائمة المتصفح وقاعدة البيانات.

✨ المميزات في إصدار v01.06:
    • 🛡️ نظام الـ Smart Git Pull-Rebase Engine للتعاون بدون أي تعارض على فرع main.
    • 🌐 المزامنة السحابية المزدوجة التلقائية مع قائمة المتصفح (Sidebar Recents).
    • 📊 تقرير تنفيذ شامل يوضح اسم الشات وحالته (جديد / استمرار) ورصيد الحساب.
    • 📁 مصفوفة الملفات الأصلية (Native files Payload) ودعم الصور ومجلد chat_attachments/.
    • 🔄 التدوير التلقائي للـ IP واستعادة التوكن ذاتياً (Self-Healing Authentication).
...
class Config:
    ...
    SESSION_TOKEN: str = "5U2cxQ0eCczzpQM-067Mm5Iqo4x2gW9lP-noq4LNn18"
...
def print_banner(client: 'NoteGPTAgentClient', sources: List[SourceItem] = None):
    ...
    print(f"{C_MAGENTA}🤖 NoteGPT Real Agent Sandbox Tester v01.06 — Smart Rebase & Browser Sync{C_RESET}")
